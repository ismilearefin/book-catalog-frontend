...
export default function HeroSection() {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <img src="https://images.unsplash.com/photo-1660188100799-af3a830ac107?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" className="max-w-sm rounded-lg shadow-2xl" />
    <div>
